...
class VelRolloutStorage:
    """Rollout storage for velocity estimator PPO."""
    ...
    def mini_batch_generator(self, num_mini_batches, num_epochs=8):
        ...
        for epoch in range(num_epochs):
            for i in range(num_mini_batches):
                ...
                yield obs_batch, critic_observations_batch, actions_batch, next_critic_observations_batch, \
