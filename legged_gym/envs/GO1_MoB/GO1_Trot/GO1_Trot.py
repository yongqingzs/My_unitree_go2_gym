...
from legged_gym.envs.GO1_MoB.GO1_Trot.GO1_Trot_config import GO1_Trot_Cfg_Yu
...
class GO1_Trot_Robot(BaseTask):
    def __init__(self, cfg: GO1_Trot_Cfg_Yu, sim_params, physics_engine, sim_device, headless):
